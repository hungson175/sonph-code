...
class DeepSeekChat:
    ...
    def __init__(self, api_key: str = None, model: str = "deepseek-chat"):
        ...
        if not self.api_key:
            raise ValueError("DeepSeek API key is required. Set DEEPSEEK_API_KEY environment variable or pass as parameter.")
...
💬 Just type your message and press Enter to chat!
    ...
    def show_model_info(self):
        ...
        print(f"   LangChain Integration: ChatOpenAI (DeepSeek API)")
