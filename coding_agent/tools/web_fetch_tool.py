...
class WebFetchLLM:
    ...
    def get_llm(self):
        ...
        if self._llm is None:
            # Use a smaller, faster model for web content processing
            # This can be claude-3-haiku or claude-3-5-haiku for speed
            self._llm = ChatAnthropic(
                model="claude-3-5-haiku-20241022",  # Fast model for content processing
...
"""
    try:
        ...
        if not parsed_url.scheme or not parsed_url.netloc:
            return f"Error: Invalid URL format. Please provide a fully-formed URL like https://example.com"
