...
def show_startup_screen(agent_count=None, working_dir=None):
    ...
    if working_dir:
        print(Fore.CYAN + Style.BRIGHT + "Working Directory: " + Fore.WHITE + working_dir)
    
    if agent_count:
        print(Fore.GREEN + Style.BRIGHT + "Available Agents: " + Fore.WHITE + f"{agent_count['total']} total " + 
              Fore.CYAN + f"({agent_count['built_in']} built-in, {agent_count['user_defined']} user-defined)")
